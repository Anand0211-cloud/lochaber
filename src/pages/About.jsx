...
const About = () => {
  return (
    <Layout>
      <SEO 
        title="Wolf Probst | 40 Jahre Immobilienexpertise & KI-Beratung"
        description="Lernen Sie Wolf Probst kennen, den Gründer von Lochaber Consulting. 40 Jahre Erfahrung im Projektmanagement trifft auf modernste KI-Analyse."
      />
      <main className="pb-24">
              ...
              <div className="lg:col-span-5 relative mt-12 lg:mt-0">
                <div className="aspect-[4/5] bg-surface-container-low overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] relative border border-white/10 group">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 p-6 bg-white/5 backdrop-blur-md border border-white/10">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-secondary mb-1">Institutionelles Vermächtnis</p>
                    <p className="text-white text-xs font-medium">Über 40 Jahre praktische Branchenerfahrung.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              <div>
                <p className="text-2xl lg:text-3xl text-primary font-bold leading-tight mb-8">
                  Energieeffizienz-Experte, Projektentwickler und Fachbuchautor.
                </p>
                <div className="w-16 h-1 bg-secondary mb-8"></div>
              </div>
              <div className="space-y-6">
                <p className="text-on-surface-variant leading-relaxed text-lg">
                  Wolf Probst bringt über 40 Jahre praktische Erfahrung in der Immobilienbranche mit. Als publizierter Autor hat er Branchenstandards für zukunftssichere Immobilienentwicklung definiert.
                </p>
                <p className="text-on-surface-variant leading-relaxed">
                  Mit Lochaber überbrückt er die Lücke zwischen KI-gestützter Datenanalyse und praxisorientierter Beratung und stellt sicher, dass jeder Datenpunkt in umsetzbare Business Intelligence übersetzt wird.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-32 px-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-px bg-outline-variant/20 overflow-hidden border border-outline-variant/20">
            ...
            <div className="md:col-span-3 lg:col-span-6 bg-surface-container-highest p-8 md:p-12 flex flex-col justify-between min-h-[280px] md:h-[320px]">
              ...
              <p className="text-on-surface-variant leading-relaxed opacity-80">Langjährige strategische Kontakte zu Bestandshaltern, Banken und dem europäischen PropTech-Ökosystem.</p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center">
              <div className="py-24 relative z-10 pr-12">
                ...
                <div className="space-y-8 text-on-primary-container leading-relaxed max-w-lg">
                  <p className="text-xl">
                    Lochaber kombiniert die analytische Kraft künstlicher Intelligenz mit dem Urteilsvermögen eines erfahrenen Immobilienexperten.
                  </p>
                  <p className="opacity-70">
                    Alle Analysen und Berichte erscheinen im Lochaber-Design – für ein konsistentes, professionelles Markenbild bei Ihren Kunden.
                  </p>
                </div>
              </div>
              <div className="h-full relative overflow-hidden group">
                <img alt="Analyse-Grafik" className="w-full h-full object-cover grayscale opacity-60 group-hover:opacity-100 group-hover:scale-105 transition-all duration-1000" src={analysisGraphic} />
        ...
        <section className="text-center py-16 border-t border-outline-variant/20 max-w-4xl mx-auto px-8">
          <h2 className="text-3xl font-bold text-primary mb-6 tracking-tighter">Bereit für eine Expertenberatung?</h2>
          <p className="text-lg text-on-surface-variant mb-10">
            Vereinbaren Sie ein persönliches Beratungsgespräch mit Wolf Probst für institutionelle Antworten auf die Fragen Ihres Immobilienportfolios.
          </p>
