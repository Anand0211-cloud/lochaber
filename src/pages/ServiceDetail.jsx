    ...
    return (
      <Layout>
        <div className="pt-40 pb-20 text-center">
          <h1 className="text-3xl font-bold mb-4">Leistung nicht gefunden</h1>
          <button onClick={() => navigate('/services')} className="text-emerald-600 hover:underline">Zurück zu den Leistungen</button>
        </div>
      </Layout>
    );
  }
            ...
            <div className="lg:col-span-7">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <div className="bg-surface-container-low p-8 border-l-4 border-primary">
                  <h4 className="text-[0.65rem] font-bold text-outline uppercase tracking-widest mb-4">Zielgruppe</h4>
                ...
                <div className="bg-surface-container-low p-8 border-l-4 border-secondary">
                  <h4 className="text-[0.65rem] font-bold text-outline uppercase tracking-widest mb-4">Lieferzeit</h4>
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-32">
                <div className="bg-[#003036] p-12 text-on-primary shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="py-8 border-y border-white/10 mb-8">
                      <p className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-secondary mb-2">Investition</p>
                    ...
                    <ul className="space-y-4 mb-12">
                      <li className="flex items-center gap-3 text-sm font-['Inter'] text-primary-fixed/80">
                        ...
                        Lochaber Premium-Qualitätssiegel
                      </li>
                      <li className="flex items-center gap-3 text-sm font-['Inter'] text-primary-fixed/80">
                        <span className="material-symbols-outlined text-secondary text-lg">check_circle</span>
                        Institutionelle Analysequalität
                      </li>
                      <li className="flex items-center gap-3 text-sm font-['Inter'] text-primary-fixed/80">
                        <span className="material-symbols-outlined text-secondary text-lg">check_circle</span>
                ...
                <div className="mt-8 p-8 border border-outline/10 bg-surface-container-low text-center">
                  <p className="text-xs font-bold text-outline uppercase tracking-widest mb-4">Individuellen Ansatz gewünscht?</p>
                  <Link to="/contact" className="text-primary font-bold hover:text-secondary transition-colors text-sm">Beratungstermin vereinbaren →</Link>
                </div>
              </div>
            </div>
          </div>
